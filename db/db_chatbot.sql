...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 06, 2021 lúc 02:43 AM
...
(37, 'Trần Ngọc Lý', 'tnduy.16.06.1998@gmail.com', '6bf26647b70c39a7e748fc52a0a14efc', 'not found', 'Enable', '68bbf7aad99ac2d3475a434d322ee0dc', 'Logout', '21-02-2021'),
...
(41, 'Nguyễn Hoàng Phúc', 'tnly.16.06.1998@gmail.com', '96235b2e65e5cbd266cc697184e2402f', 'not found', 'Enable', '446a5d017dff9203b5498d855d875d2b', 'Logout', '06-03-2021');
...
--
ALTER TABLE `tbl_members`
  MODIFY `id_member` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT cho bảng `tbl_room`
--
ALTER TABLE `tbl_room`
  MODIFY `id_room` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
